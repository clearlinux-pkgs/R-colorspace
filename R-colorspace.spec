...
Version  : 2.0.2
Release  : 86
URL      : https://cran.r-project.org/src/contrib/colorspace_2.0-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/colorspace_2.0-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624548079
