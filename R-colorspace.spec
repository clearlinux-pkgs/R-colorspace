...
Version  : 2.1.1
Release  : 105
URL      : https://cran.r-project.org/src/contrib/colorspace_2.1-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/colorspace_2.1-1.tar.gz
...
%prep
%setup -q -n colorspace
pushd ..
cp -a colorspace buildavx2
popd
pushd ..
cp -a colorspace buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722278403
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/colorspace/libs/colorspace.so
/V4/usr/lib64/R/library/colorspace/libs/colorspace.so
